...
#endif
           // cout << fullImages[clData.inds[2]][0](Rect(100,100,1000,1000)).size() << endl;
            //cout << "lala" << endl;
...
void KilobotTracker::SETUPfindKilobots()
{
    ...
    QImage qimg((uchar *) display.data,display.cols, display.rows, display.step,QImage::Format_RGB888);
